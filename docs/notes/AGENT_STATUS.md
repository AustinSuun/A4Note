# A4 Note Agent 状态
- reader-page-control-xingxu：星序领取 f4ea1a89 spec2，独立分支 fix/reader-page-control-xingxu 基于 main f891c15。隔离16页PDF已复现：点总页数不聚焦；第2页输入草稿1后点控件内部，滚动从950.4降到7.2并失焦。新增浏览器旧版23通过/32失败。正在局部修复并补提交/取消/文档身份回归，不打包安装发布。更新：2026-09-24T08:34:27+08:00
