...
const files=['manifest.json','popup.html','popup.css','popup.js','collector.js','normalize.mjs','enrich-page.mjs','bridge.mjs','native-bridge.mjs','bridge-ui.js','browser-assist.mjs','README.md'];
