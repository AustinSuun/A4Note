...
await test('compact excerpt preserves all text for geometry clipping and replaces image markup', () => { for (const zoom of [40,60,100,220]) assert.equal(summaryExcerpt('x'.repeat(10000),zoom).length,10000); assert.equal(summaryExcerpt('![image](summary-assets/a.png)',60),'〔图片〕'); });
