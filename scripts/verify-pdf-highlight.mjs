...
const position={x:10,y:20,width:30,height:2};const copy=JSON.stringify(position);eq(h.highlightRects(position),[{x:10,y:20.08,width:30,height:2}]);eq(JSON.stringify(position),copy);
