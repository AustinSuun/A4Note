...
const shortDock={id:'short-dock',width:30,height:29,anchor:{left:173,top:480,right:218,bottom:525}};
const longDock={id:'long-dock',width:146,height:29,anchor:{left:224,top:480,right:269,bottom:525}};
const noteMenu={left:34,top:401,right:119,bottom:436};
const wideFirst=layoutShortcutHints([shortDock,longDock],{left:8,top:8,right:792,bottom:592},[shortDock.anchor,longDock.anchor,noteMenu]);
check(wideFirst['long-dock']?.placement==='adjacent'&&wideFirst['short-dock']?.placement==='adjacent','wide dock chord keeps its anchor when a neighboring short key must move up a row');
