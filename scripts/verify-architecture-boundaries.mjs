...
assert.match(markdownReadContentSource, /<PaperNoteImage paperId=\{paper.paperId\}/);
const paperNoteImageSource = await readFile('src/features/reader/PaperNoteImage.tsx', 'utf8');
assert.match(paperNoteImageSource, /<MarkdownFigure /);
assert.match(paperNoteImageSource, /paperNoteImageDocument\(paperId, 'read'\)/);
